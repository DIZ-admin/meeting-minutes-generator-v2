"""
Базовый класс для асинхронных адаптеров языковых моделей (LLM)
"""
...
class AsyncLLMAdapter(ABC):
    """
    Абстрактный класс для асинхронных адаптеров языковых моделей (LLM)
    
    Все конкретные реализации асинхронных LLM должны наследоваться от этого класса
    ...
    async def generate_text(
        ...
        **kwargs
        ...
        """
        Асинхронно генерирует текст на основе промпта
    ...
    async def generate_json(
        ...
        **kwargs
        ...
        """
        Асинхронно генерирует JSON на основе промпта
